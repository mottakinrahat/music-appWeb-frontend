...
const CurrentPlayingUsers = ({
  ...
  return (
    <div>
      ...
      >
        <Avatar className="w-8 h-8 border-white border-2 cursor-pointer">
          <AvatarImage src="https://cdn-icons-png.freepik.com/512/7718/7718888.png" />
          <AvatarFallback>CN</AvatarFallback>
        </Avatar>
        <Avatar className="w-8 h-8 -mx-4 cursor-pointer border-white border-2">
          <AvatarImage src="https://cdn-icons-png.freepik.com/512/7718/7718888.png" />
          <AvatarFallback>CN</AvatarFallback>
        </Avatar>
        <Avatar className="w-8 h-8 border-white cursor-pointer border-2">
          <AvatarImage src="https://cdn-icons-png.freepik.com/512/7718/7718888.png" />
          <AvatarFallback>CN</AvatarFallback>
        </Avatar>
        <p className="mx-2">
