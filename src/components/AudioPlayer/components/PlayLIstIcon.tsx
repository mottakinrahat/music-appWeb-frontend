...
const ShowLyricsIcon: React.FC<PlayListProps> = ({
  ...
  return (
    <div className={className} onClick={handleOpenLyrics}>
      <svg
        width="22"
        height="21"
        viewBox="0 0 22 21"
        ...
        className={`icon ${
          importedUrl ? "cursor-not-allowed fill-gray-400" : " cursor-pointer "
        }  transition ${isShowLyrics ? "fill-accent" : "fill-white"}`}
      >
